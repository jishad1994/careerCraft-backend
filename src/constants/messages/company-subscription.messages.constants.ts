export const COMPANY_SUBSCRIPTION_MESSAGES = {
    ...
    SUBSCRIPTION_CANCELLED_SUCCESSFULL: "Subscription cancelled successfully",

    PAYMENT_INITIATED: "Payment initiated and subscribed successfully",

    PAYMENT_STATUS_RETRIEVED: "Payment status retrieved",

    PAYMENT_REINITIATED: "Payment reinitiated ",
